      ...
      <div className="h-[90vh] flex justify-between p-8 w-full bg-black">
        <div className=" w-1/2">
          ...
          <div className="flex  gap-7 justify-start items-center mt-[8em]  ml-[8.5em] text-amber-50">
            ...
            <Link className="text-[20px] relative inline-block  font-medium after:absolute after:left-0 after:bottom-0 after:h-[2px] after:w-0 after:bg-white after:transition-all after:duration-800 hover:after:w-full">
              LinkedIn
            </Link>
            <Link className="text-[20px] relative inline-block  font-medium after:absolute after:left-0 after:bottom-0 after:h-[2px] after:w-0 after:bg-white after:transition-all after:duration-800 hover:after:w-full">
              Github
