...
const Project = () => {
    ...
    return (
        <section className='relative  w-full h-[305vh] bg-[linear-gradient(to_bottom,_#060016_5%,__#060022_95%)] text-white'>
            <div className=''>
                <motion.h1
            ...
            <div className='page1 absolute top-[5%] left-[10%] w-[36vw] h-[90vh]'>
                <div className='w-[100%] h-[80%]  border-0 rounded-[10px] overflow-hidden shadow-2xl'>
            ...
            <div className='page2 absolute top-[23%] right-[10%]  w-[36vw] h-[90vh] ' >
                <div className='w-[100%] h-[80%] rounded-[10px]  overflow-hidden shadow-2xl '><img src={image2} className='h-full  object-cover transition duration-300 ease-in  hover:scale-[1.05] ' /></div>
                <div className="relative w-[100%] h-[40%] ">
            ...
            <div className='page3 w-[36vw] h-[90vh]  absolute top-[44%] left-[10%] ' >
                <div className='w-[100%] h-[80%] rounded-[10px]  overflow-hidden shadow-2xl '><img src={image3} className='h-full  object-cover transition duration-300 ease-in  hover:scale-[1.05] ' /></div>
                <div className="relative w-[100%] h-[40%] ">
                    <h3 className='font-[500] text-[20px]  mt-3'>Website for product and industrial designer who creates complete experiences</h3>
                    <span className='absolute top-[69px] left-[-16px] text-4xl text-green-600 '><RiDoubleQuotesL /></span>
                    <p className='font-[400] text-white/70 text-[13px] ml-7 mt-3'>Our To-Do List app is designed to keep you focused and organized. Quickly add tasks, set priorities, and track your progress as you complete each goal.</p>
            ...
            <div className='absolute bottom-0 left-[13%] w-[70%] h-14'>
                <div className='flex  '>
                    ...
                    <div className='flex items-center gap-8 ml-25'>
                        ...
                        {/* ADD THIS LINK & EDIT LINK   START*/}
                        
          <Link
            to="/Project/ProjecSection"
            className="text-2xl 
           text-amber-50  ml-[22px] relative inline-block  font-medium after:absolute after:left-0 after:bottom-0 after:h-[2px] after:w-0 after:bg-white after:transition-all after:duration-800 hover:after:w-full"
          >
            See more work
          </Link>
{/*  END */}
